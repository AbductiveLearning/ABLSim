...
class TwoDigitAddDataGenerateCIFAR:
    def __init__(self, raw_dara_path, mode = "train", shape = (32, 32)):
        self.raw_data_path = raw_dara_path
        self.expr_train = load_expr(raw_dara_path, "train_data_cifar.txt")
        self.expr_test = load_expr(raw_dara_path, "test_data_cifar.txt")
        self.mode = mode
